  ...
  return (
    <>
      ...
      <div
        ...
        className={`${
          isOpen ? "top-0 translate-x-[-100%]" : ""
        } top-0 fixed w-full h-full z-10 duration-700 right-[-100%]`}
      >
        <div
          className="ml-auto w-[90vw] flex flex-col md:w-[30vw] md:min-w-[350px] h-full bg-white p-5"
